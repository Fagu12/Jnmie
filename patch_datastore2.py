...
keys_append = """        val LAST_SYNCED_TIMESTAMP = longPreferencesKey("last_synced_timestamp")
...
content = content.replace("""        val LAST_SYNCED_TIMESTAMP = longPreferencesKey("last_synced_timestamp")
        val ANILIST_AUTH_TOKEN = stringPreferencesKey("anilist_auth_token")
        val ANILIST_USERNAME = stringPreferencesKey("anilist_username")
    }""", keys_append)
...
update_append = """            preferences[PreferencesKeys.AUTO_SYNC_ANILIST] = newSettings.autoSyncAniList
            preferences[PreferencesKeys.LAST_SYNCED_TIMESTAMP] = newSettings.lastSyncedTimestamp
